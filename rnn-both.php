...
<h1 align=center> Machine Learning Music Serve by Jeremy Ellis </h1>


<h2 align=center>Check out the live kickstarter at <a href="https://www.kickstarter.com/projects/rocksetta/rocksetta-neural-network-machine-learning-mp3-crea">
     https://www.kickstarter.com/projects/rocksetta/rocksetta-neural-network-machine-learning-mp3-crea<br>
     <img width=300 src="rock-kick.jpg"></a></h2>
...
<form action="rnn-both.php" method="POST">
 ...
 --save_dir  <select name="go1" >
     <option value="<?php echo ($_POST['go1'] |= "")? $_POST['go1'] : "save-new5" ?>"><?php echo ($_POST['go1'] |= "")? $_POST['go1'] : "save-new5" ?> </option>
...
<h1 align=center>To play in your browser</h1>

Click the "Convert" button and then choice "Play Single Note" note or "Play Chords" (Chords may not work well unless you have a powerful computer)<br>

Change key with "+"  or "-" and use slider to change the speed.<br><br>

<b style="color:red;">Note: This is a demonstration. These datasets have not been trained for any specific music genre.</b><br><br>


<input type=button style="font-size:25px; color:red" value="Convert" id="myGo" onclick="{
...
<input type=button value="Play Single Notes" onclick="{
...
<input type=button value="Play Chords" onclick="{
...
<b></b>,  =lower octave  ' = higher octave,   - = no sound,   _ = continue note <br><br>
0 = root note (lets say C), 1 = C#, 2 = D, 3 = D#, 4 = E, 5 = F, 6 = F#, 7 = G, 8 = G#, 9 = A, @ = A#, * = B, 'C = C up an octave </b><br> <br> 
...
<textarea id="myArea01" rows=20 cols=50><?php echo ($output |= "")? $output : ",* 2 4 2___ 2 2 7 9 * 7___ 7 9 * * * * '0 * 9 7 9____ 6 7 9 9 9 9 9____ 7 9 7 6___ 7 6 4 2_ 0_ ,*____" ?></textarea>
